...
export default function NavBar() {
  ...
  return (
    <div className="absolute z-10 bottom-5 sm:bottom-auto sm:left-10 bg-black flex sm:flex-col items-center justify-around w-full p-1 sm:p0 sm:w-[4rem] sm:h-[30rem] rounded-xl ">
